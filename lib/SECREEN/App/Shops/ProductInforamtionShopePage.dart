...
import 'package:untitled3/SECREEN/App/Shops/PrudactdDetilseShopePgae.dart';
...
class PageProductInforamtionPageForShops extends StatelessWidget {
  const PageProductInforamtionPageForShops({super.key});
                        ...
                        children: [
                          Expanded(
                              child: KH_ShadowCard(
                                  ...
                                  outsideMargin: 10,
                                  borderRadius: 5,
                                  child: DelivryAndStarAndOpenOrCloseShops(
                                    colors: Colors.brown,
                                    text: "5",
                        ...
                        children: [
                          Expanded(
                            child: KH_ShadowCard(
                              ...
                              outsideMargin: 10,
                              borderRadius: 10,
                              child: CartAndInfoAndFavoriteShope(
                                  onTap: () {
            ...
            CardForDetilseShops(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => ProductDetailShopePage()));
                }),
          ],
        ),
      )),
...
class DelivryAndStarAndOpenOrCloseShops extends StatelessWidget {
  final String text;
  final String icons;
  final Color colors;
  final void Function()? onTap;
  const DelivryAndStarAndOpenOrCloseShops(
      {super.key,
      required this.text,
      required this.icons,
      this.onTap,
...
class CartAndInfoAndFavoriteShope extends StatelessWidget {
  final String text;
  final String icons;
  final void Function()? onTap;

  const CartAndInfoAndFavoriteShope(
...
class FavoriteShope extends StatelessWidget {
  final String text;
...
class CardForDetilseShops extends StatelessWidget {
